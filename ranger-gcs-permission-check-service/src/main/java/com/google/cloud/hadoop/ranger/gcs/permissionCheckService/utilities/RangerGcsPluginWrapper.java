...
/**
 * Wrapper interface for RangerGcsPlugin.
 */
public interface RangerGcsPluginWrapper {

    void init();

    void stop();

    RangerGcsPermissionCheckResult isAccessAllowed(String user, Set<String> userGroups,
